...
$(function(){
	...
	//Get BACK/WIN data
	$.get( "/betsreport?market=WIN&bettype=BACK", function(data) {
...
/*
	...
	//Get BACK/PLACE data
	$.get( "/betsreport?market=PLACE&bettype=BACK", function(data) {
	...
	//Get LAY/PLACE data
	$.get( "/betsreport?market=PLACE&bettype=LAY", function(data) {
