...
nconf.defaults(
{
    ...
    "logging":{
     ...
     "port":"3000",
     "code":'FLAT',
     "dateOffset":360, //form in last 90 days,
     "standardDeviation": 0.272,//0.0272
...
var betCursor=db.bets.find({rpraceid:'644592',horseids:{$exists:true},marketType:'WIN',racetype:'FLAT'});
