...
var runnerid=nconf.get("runnerid");
...
MongoClient.connect(databaseUrl,function(err,db){
    ...
    processOnePerformance(db,""+raceid,""+runnerid);
});


function processOnePerformance(db,rid,runnerid){

  db.collection("perfstocheck").findOne({message:{$exists:false},raceid:rid,runnerid:runnerid},function(err,perf){
  	//logger.info(rid + " " + runnerid);
  	if(err){
